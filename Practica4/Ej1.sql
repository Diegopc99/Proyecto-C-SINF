...
ALTER TABLE Actores ADD fotografia longblob;
ALTER TABLE Directores ADD fotografia BLOB;
ALTER TABLE Peliculas ADD fotografia BLOB;


UPDATE Actores SET fotografia = LOAD_FILE('/home/diego/Imágenes/Captura1.png') WHERE Actores.ID_actor=1;
