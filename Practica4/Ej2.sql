...
ALTER TABLE Actores ADD valoracion FLOAT(3,2);

UPDATE Actores SET valoracion=1.23 WHERE Actores.nombre= "Jason Statham";
UPDATE Actores SET valoracion=10.00 WHERE Actores.nombre="Leonardo DiCaprio";
UPDATE Actores SET valoracion=9.99 WHERE Actores.nombre="Vin Diesel";
UPDATE Actores SET valoracion=1.234 WHERE Actores.nombre="Emma Watson";
