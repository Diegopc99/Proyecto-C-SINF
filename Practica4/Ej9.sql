...
CREATE VIEW titulo_nacionalidad AS SELECT * FROM Peliculas WHERE Peliculas.ID_pelicula > 2;
...
UPDATE titulo_nacionalidad SET Peliculas.nombre="Pepino" WHERE Peliculas.ID_pelicula = 1;
